...
export const api = {
  ...
  fileUpdateKeys: (fileId, keys) => invoke("file_update_keys", { fileId, keys }),
  fileReanalyze: (fileId) => invoke("file_reanalyze", { fileId }),
  fileBind: (fileId, bindings) => invoke("file_bind", { fileId, bindings }),
  fileRemove: (fileId) => invoke("file_remove", { fileId }),
  ...
  fileSync: (fileId) => invoke("file_sync", { fileId }),
  fileSyncAll: () => invoke("file_sync_all"),
